  ...
  return (
    <div className="flex h-full flex-col justify-between p-3 md:p-4">
        ...
        <nav className="flex flex-col gap-0.5">
          {nav.map(({ to, label, icon: Icon }) => {
            ...
            return (
              ...
              >
                <Icon className={`${collapsed ? "h-5 w-5" : "h-4 w-4"}`} strokeWidth={1.75} />
      ...
      <div className="space-y-3">
        ...
        >
          {theme === "dark" ? (
            <Sun className={`${collapsed ? "h-5 w-5" : "h-4 w-4"}`} strokeWidth={1.75} />
          ) : (
            <Moon className={`${collapsed ? "h-5 w-5" : "h-4 w-4"}`} strokeWidth={1.75} />
          )}
